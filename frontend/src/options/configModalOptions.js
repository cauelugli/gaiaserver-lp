...
export const configModalOptions = (userName, userId, configCustomization) => [
  {
    icon: React.createElement(icons.CalendarMonthIcon, {
      sx: { fontSize: "4vw" },
    }),
    text: "Agenda",
  ...
  {
    icon: React.createElement(icons.InsertDriveFileIcon, {
      sx: { fontSize: "4vw" },
    }),
    text: "Arquivos",
  ...
  {
    icon: React.createElement(icons.AttachMoneyIcon, {
      sx: { fontSize: "4vw" },
    }),
    text: "Financeiro",
  ...
  {
    icon: React.createElement(icons.NotificationsIcon, {
      sx: { fontSize: "4vw" },
    }),
    text: "Notificações",
  ...
  {
    icon: React.createElement(icons.AssessmentIcon, {
      sx: { fontSize: "4vw" },
    }),
    text: "Relatórios",
